...
private:
    ...
    bool initialized;
    bool audioAvailable;
    Mix_Chunk *chunk_munch_a;
    Mix_Chunk *chunk_munch_b;
    int channel_munch;
    bool munch_toggle;
    Mix_Music *music_intro;
    Mix_Music *music_siren_slow;
    Mix_Music *music_siren_medium;
    Mix_Music *music_siren_fast;
    Mix_Music *music_superpill_loop;
    Mix_Music *music_eat_ghost;
    Mix_Chunk *chunk_dying;
    Mix_Chunk *chunk_extra_man;
    Mix_Chunk *chunk_fruit;
    Mix_Chunk *chunk_eat_ghost;
